...
EN = {
    ...
    "តាមដានការបង់ថ្លៃសិក្សាជារៀល (KHR)": "Track tuition in KHR",
    ...
    "បន្ថែមគ្រូ": "Add teacher",
    "បង្កើតគណនីគ្រូបង្រៀន។ ផ្អាកគណនី មិនលុបប្រវត្តិ។": "Create a teacher account. Deactivate accounts; history is kept.",
    ...
    "វាយស្វែងរកឈ្មោះសិស្ស": "Search student name",
    "វាយស្វែងរកតាមឈ្មោះសិស្ស។": "Search by student name.",
    ...
    "ចំណូលគិតជារៀល (KHR)។ ចំណូលសុទ្ធ = ការបង់ − ការសង។": "Revenue is in KHR. Net revenue = payments − refunds.",
