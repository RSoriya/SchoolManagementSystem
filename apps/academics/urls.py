...
urlpatterns = [
    ...
    path("classes/<int:pk>/results/excel/", views.class_results_excel, name="class_results_excel"),
    path("classes/<int:pk>/results/pdf/", views.class_results_pdf, name="class_results_pdf"),
